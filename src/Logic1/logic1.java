...
public class logic1 {
	...
	public boolean in1To10(int n, boolean outsideMode) {
		if (n >= 1 && n <= 10 && !outsideMode) {
			...
			return (outsideMode && n <= 1) || (outsideMode && n >= 10) ? true : false;
		}
	}
	...
	public String fizzString(String str) {
		if (str.indexOf('f') == 0 && str.lastIndexOf('b') == str.length() - 1) {
			return "FizzBuzz";
		} else if (str.indexOf('f') == 0) {
			return "Fizz";
		} else if (str.lastIndexOf('b') == str.length() - 1) {
			return "Buzz";
		} else {
			return str;
		}
	...
	public boolean lastDigit(int a, int b, int c) {
		boolean result = (a % 10 == b % 10) || (b % 10 == c % 10) || (a % 10 == c % 10);
		if (result) {
			return true;
		} else {
			return false;
	...
	public boolean lessBy10(int a, int b, int c) {
		...
		int bc = b - c;
		int ca = c - a;
		if (Math.abs(ab) >= 10 || Math.abs(bc) >= 10 || Math.abs(ca) >= 10) {
			return true;
		} else {
			return false;
		}
	...
	public int greenTicket(int a, int b, int c) {
		boolean three = (a == b) && (b == c) && (c == a);
		boolean two = (a == b || b == c || c == a);
		if (three) {
			return 20;
		} else if (two) {
			return 10;
	...
	public boolean shareDigit(int a, int b) {
		boolean result = ((a / 10) == (b % 10)) || ((b / 10) == (a % 10));
		boolean result2 = ((a / 10) == (b / 10)) || ((b % 10) == (a % 10));
		if (result || result2) {
			return true;
		} else {
			return false;
