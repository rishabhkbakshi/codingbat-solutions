...
public class string1 {
	...
	public String middleThree(String str) {
		if (str.length() > 3) {
			String temp = "";
			if (str.length() % 2 != 0) {
				temp = str.substring((str.length() - 1) / 2 - 1, ((str.length() - 1) / 2) + 2);
			}
			return temp;
		} else {
			return str;
	...
	public String lastChars(String a, String b) {
		String finalString = (a.length() == 0 ? "@" : a.substring(0, 1))
	...
	public String lastTwo(String str) {
		if (str.length() > 2) {
			...
			for (int i = temp2.toCharArray().length - 1; i >= 0; i--) {
				temp = temp + temp2.toCharArray()[i];
			}
			return temp;
		} else {
			String t1 = "";
			for (int i = str.toCharArray().length - 1; i >= 0; i--) {
				t1 = t1 + str.toCharArray()[i];
			}
			return t1;
		}
	}
	...
	public boolean frontAgain(String str) {
		...
		return str.length() < 2 ? false : result;
	}
	...
	public String deFront(String str) {
		...
		if (str.length() >= 2) {
			if (str.toCharArray()[0] == 'a') {
				String temp = str.toCharArray()[1] == 'b' ? str.toCharArray()[1] + "" : "";
				result = str.toCharArray()[0] + temp + str.substring(2, str.length());
			} else if (str.toCharArray()[1] == 'b') {
				result = str.toCharArray()[1] + str.substring(2, str.length());
			} else {
	...
	public String startWord(String str, String word) {
		String first = str.length() == 0 ? "" : str.substring(1, str.length());
		String second = word.length() == 0 ? "" : word.substring(1, word.length());
	...
	public String withoutX2(String str) {
		...
		if (str.toCharArray()[0] == 'x' && str.toCharArray()[1] == 'x') {
			return str.substring(2, str.length());
		} else if (str.toCharArray()[0] == 'x') {
			return str.substring(1, str.length());
		} else if (str.toCharArray()[1] == 'x') {
			return str.toCharArray()[0] + str.substring(2, str.length());
		} else {
			return str;
		}
	}
