...
public class map1 {
	...
	// mapBully({"a": "candy", "b": "carrot", "c": "meh"}) => {"a": "", "b":
	// "candy", "c": "meh"}
	...
	//
	//
	// mapShare({"a": "aaa", "b": "bbb", "c": "ccc"}) => {"a": "aaa", "b":
	// "aaa"}
	// mapShare({"b": "xyz", "c": "ccc"}) => {"b": "xyz"}
	// mapShare({"a": "aaa", "c": "meh", "d": "hi"}) => {"a": "aaa", "b": "aaa",
	// "d": "hi"}
	...
	// "cherry"}
	// topping2({"spinach": "dirt", "ice cream": "cherry"}) => {"yogurt":
	...
	// topping3({"salad": "oil", "potato": "ketchup"}) => {"spinach": "oil",
	...
	// mapAB2({"a": "aaa", "b": "bbb", "c": "aaa"}) => {"a": "aaa", "b": "bbb",
	// "c": "aaa"}
	...
	//
	//
	// mapAB3({"a": "aaa", "c": "cake"}) => {"a": "aaa", "b": "aaa", "c":
	// "cake"}
	// mapAB3({"b": "bbb", "c": "cake"}) => {"a": "bbb", "b": "bbb", "c":
	// "cake"}
	...
	// "c": "aaa"}
	// mapAB4({"a": "aa", "b": "bbb", "c": "cake"}) => {"a": "aa", "b": "bbb",
	// "c": "bbb"}
